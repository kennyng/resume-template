...
\newcommand*{\Job}[6]{%
  ...
  \begin{tabular}{l|p{0.8\textwidth}}
    \ifthenelse{\isempty{#4}}
      {\styleDate{#1} & \styleJobTitle{#5} \formatSeperator
            \styleCompanyName{#3} \\
...
% ----------------------------------------------------------------------------
% Define environment for Skill section.
\newenvironment{SkillSection}{%
  ...
  \begin{center}
    ...
    \setlength{\extrarowheight}{0pt}
    \begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} r L{\textwidth * \real{0.75}}}
}{%
    \end{tabular*}
  \end{center}
}
...
\newcommand{\formatSeperator}{\enskip\textbar\enskip}
...
\begin{SkillSection}
    \Skill
        ...
        {English, Cantonese Chinese, Mandaring Chinese, Spanish} % List of Skills
